...
class Recipe(models.Model):
    ...
    image = models.ImageField("Ссылка на изображение", upload_to="recipes/images/")
...
class IngredientRecipes(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["recipes", "ingredients"], name="unique_ingredients_recipes"
            )
        ]
...
class ShoppingList(models.Model):
    ...
    recipes = models.ForeignKey(Recipe, verbose_name="Рецепт", on_delete=models.CASCADE)
    ...
    class Meta:
        ...
        constraints = [
            ...
            models.CheckConstraint(
                name="user_is_not_author", check=~models.Q(user=models.F("author"))
            ),
        ]
